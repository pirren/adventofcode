...
describe('advent of code 2024', () => {
    ...
    it('day 13, part 1', async function() {
        await test({ year: 2024, day: 13, part: 1, expected: 31897 })
    })
    it('day 13, part 2', async function() {
        await test({ year: 2024, day: 13, part: 2, expected: 12345 })
    })
    it('day 14, part 1', async function() {
        await test({ year: 2024, day: 14, part: 1, expected: 229632480 })
    })
    it('day 14, part 2', async function() {
        await test({ year: 2024, day: 14, part: 2, expected: 7051 })
    })
    it('day 15, part 1', async function() {
        await test({ year: 2024, day: 15, part: 1, expected: 1383666 })
    })
    it('day 15, part 2', async function() {
        await test({ year: 2024, day: 15, part: 2, expected: 1412866 })
    })
    it('day 16, part 1', async function() {
        await test({ year: 2024, day: 16, part: 1, expected: 130536 })
    })
    it('day 16, part 2', async function() {
        await test({ year: 2024, day: 16, part: 2, expected: 1024 })
    })
    it('day 17, part 1', async function() {
        await test({ year: 2024, day: 17, part: 1, expected: '7,0,3,1,2,6,3,7,1' })
    })
    it('day 17, part 2', async function() {
        await test({ year: 2024, day: 17, part: 2, expected: 12345 })
    })
    it('day 18, part 1', async function() {
        await test({ year: 2024, day: 18, part: 1, expected: 436 })
    })
    it('day 18, part 2', async function() {
        await test({ year: 2024, day: 18, part: 2, expected: '61,50' })
    })
    it('day 19, part 1', async function() {
        await test({ year: 2024, day: 19, part: 1, expected: 228 })
    })
